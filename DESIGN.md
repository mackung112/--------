...
### 3.3 Simulator & Cards (Explorer Pattern)

- **Simulator Container**: `bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden mb-8 font-sans`
- **Simulator Header**: `bg-slate-50 border-b border-slate-200 p-5`
- **Interactive Container**: `flex flex-col min-h-[450px]`
- **Top 2-Column Split**: `flex flex-col lg:flex-row flex-1`
- **Console Output (VS Code Style)**: `h-48 bg-[#1e1e1e] p-4 font-mono text-[13px] overflow-y-auto flex flex-col relative w-full border-t border-slate-800`

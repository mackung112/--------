const courses = [
    {
        ...
        chapters: [
            ...
            },
            {
                ...
                lessons: [
                    { id: "3.1", title: "โครงสร้างของภาษา Python", content: `<h2>ส่วนประกอบของโปรแกรม</h2><p>มาดูกันว่าโปรแกรม Python หนึ่งโปรแกรมประกอบด้วยอะไรบ้าง และมีการแบ่งแยกประเภทข้อมูลเบื้องต้นอย่างไร</p>[PYTHON_STRUCTURE_COMPONENT]<div class="note">💡 โครงสร้างที่ดีช่วยให้โปรแกรมอ่านง่ายและจัดการง่ายขึ้น</div>` },
                    { id: "3.2", title: "กฎการตั้งชื่อตัวแปร (Naming Convention)", content: `<h2>กฎการตั้งชื่อตัวแปร</h2><p>การตั้งชื่อตัวแปรใน Python มีกฎและข้อควรระวัง ลองเรียนรู้และดูตัวอย่างที่ถูกต้อง</p>[NAMING_CONVENTION_COMPONENT]<div class="note">💡 กฎเหล็ก: ห้ามขึ้นต้นด้วยตัวเลข และห้ามใช้คำสงวน!</div>` },
                    { id: "3.3", title: "ข้อมูลประเภทตัวเลขจำนวนเต็ม (Integer)", content: `<h2>ชนิดข้อมูลจำนวนเต็ม (Integer หรือ int)</h2><p>ใช้เก็บตัวเลขที่ไม่มีทศนิยม เช่น 1, -5, 1000 ลองคำนวณพื้นฐานได้เลย</p>[INTEGER_EXPLORER_COMPONENT]<div class="note">💡 Python โชคดีตรงที่จำนวนเต็มไม่มีขีดจำกัดขนาด (Limit) เก็บเลขใหญ่แค่ไหนก็ได้ตราบที่ RAM พอ!</div>` },
                    { id: "3.4", title: "ข้อมูลประเภทตัวเลขทศนิยม (Float)", content: `<h2>ชนิดข้อมูลทศนิยม (Float)</h2><p>ใช้เก็บตัวเลขที่มีจุดทศนิยม เช่น 3.14, -0.5 ลองทดสอบความแม่นยำของมันดู</p>[FLOAT_EXPLORER_COMPONENT]<div class="note">💡 ระวัง: การคำนวณทศนิยมบางครั้งอาจเกิดความคลาดเคลื่อนเล็กน้อย (Floating Point Error)</div>` },
                    { id: "3.5", title: "ข้อมูลประเภทข้อความ (String)", content: `<h2>ชนิดข้อมูลข้อความ (String หรือ str)</h2><p>ใช้เก็บตัวอักษร ข้อความ ครอบด้วย "" หรือ '' ก็ได้ ลองใช้ Method ต่างๆ จัดการข้อความ</p>[STRING_EXPLORER_COMPONENT]<div class="note">💡 String ใน Python สามารถดึงข้อมูลตำแหน่ง (Index) ที่ต้องการได้ง่ายๆ</div>` },
                    { id: "3.6", title: "ข้อมูลประเภทตรรกศาสตร์ (Boolean)", content: `<h2>ชนิดข้อมูลตรรกศาสตร์ (Boolean หรือ bool)</h2><p>มีแค่ 2 ค่าคือ <code>True</code> (จริง) และ <code>False</code> (เท็จ) สำคัญมากสำหรับการเขียนเงื่อนไข</p>[BOOLEAN_EXPLORER_COMPONENT]<div class="note">💡 Boolean เป็นหัวใจของการตัดสินใจ (If-Else) ในโปรแกรม</div>` },
                    { id: "3.7", title: "การนำเข้าโมดูลมาตรฐานด้วยคำสั่ง <code>import</code>", content: `<h2>การใช้โมดูล (Modules)</h2><p>Python มี "เครื่องมือเสริม" หรือโมดูลมาตรฐานมากมาย เราแค่ <code>import</code> เข้ามาก็ใช้ได้เลย</p>[IMPORT_MODULE_COMPONENT]<div class="note">💡 ฟังก์ชัน <code>math.pi</code> หรือ <code>random.randint()</code> ก็มาจากโมดูลมาตรฐาน!</div>` },
                ,
                    { id: "3.8", title: "การจัดการหน่วยความจำ (Memory Management)", content: `<h2>ตัวแปรถูกเก็บในหน่วยความจำอย่างไร?</h2><p>มาดูความแตกต่างระหว่างข้อมูลที่เปลี่ยนค่าได้ (Mutable) และเปลี่ยนไม่ได้ (Immutable)</p>[MEMORY_COMPONENT]<div class="note">💡 <code>List</code> เป็น Mutable ส่วน <code>int</code> และ <code>String</code> เป็น Immutable</div>` }
                ],
                practical: [
            ...
            },
            {
                ...
                lessons: [
                    { id: "4.1", title: "ภาพรวมการควบคุมทิศทางโปรแกรม", content: `<h2>จำลองการทำงานของ Control Flow</h2><p>รวบรวมเครื่องมือสำหรับควบคุมทิศทางโปรแกรม ไม่ว่าจะเป็น Operator, เงื่อนไข หรือการวนซ้ำ</p>[CONTROL_FLOW_COMPONENT]<div class="note">💡 โปรแกรมจะเก่งขึ้นก็ต่อเมื่อมีการตัดสินใจ (If) และทำงานซ้ำได้ (Loop)</div>` },
                    { id: "4.2", title: "การรับข้อมูลด้วยคำสั่ง <code>input()</code>", content: `<h2>รับข้อมูลจากผู้ใช้</h2><p>โปรแกรมที่ดีต้องตอบสนองกับผู้ใช้ได้ ลองใช้ <code>input()</code> เพื่อรับข้อความ</p>[INPUT_DEMO_COMPONENT]<div class="note">💡 ค่าที่ได้จาก input() จะเป็นข้อความ (String) เสมอ!</div>` },
                    { id: "4.3", title: "การแสดงผลและการจัดรูปแบบข้อความด้วยคำสั่ง <code>print()</code>", content: `<h2>จัดรูปแบบการแสดงผล</h2><p><code>print()</code> ทำอะไรได้มากกว่าแค่แสดงข้อความ ลองดูพารามิเตอร์ต่างๆ</p>[PRINT_FORMAT_COMPONENT]<div class="note">💡 f-string (มีตัว f นำหน้า "") คือวิธีจัดฟอร์แมตที่ง่ายและนิยมที่สุดในปัจจุบัน</div>` },
                    { id: "4.4", title: "ตัวดำเนินการทางคณิตศาสตร์ (Arithmetic Operators)", content: `<h2>คำนวณตัวเลข</h2><p>บวก ลบ คูณ หาร และอื่นๆ ลองเปลี่ยนค่าเพื่อดูผล</p>[ARITHMETIC_OPS_COMPONENT]<div class="note">💡 <code>//</code> <code>//</code> คือหารปัดเศษทิ้ง ส่วน <code>%</code> คือการหารเอาเศษ</div>` },
                    { id: "4.5", title: "ตัวดำเนินการกำหนดค่า (Assignment Operators)", content: `<h2>กำหนดและอัปเดตค่า</h2><p>วิธีเขียนแบบย่อเมื่อต้องคำนวณและเก็บค่าลงตัวแปรเดิม</p>[ASSIGNMENT_OPS_COMPONENT]<div class="note">💡 <code>x += 1</code> มีค่าเท่ากับ <code>x = x + 1</code></div>` },
                    { id: "4.6", title: "ตัวดำเนินการเปรียบเทียบ (Comparison Operators)", content: `<h2>การเปรียบเทียบ</h2><p>ใช้สำหรับตรวจสอบเงื่อนไข ผลลัพธ์จะเป็น True หรือ False เสมอ</p>[COMPARISON_OPS_COMPONENT]<div class="note">💡 ระวัง! <code>=</code> คือการกำหนดค่า ส่วน <code>==</code> คือการเปรียบเทียบ</div>` },
                    { id: "4.7", title: "ตัวดำเนินการทางตรรกศาสตร์ (Logical Operators)", content: `<h2>เชื่อมเงื่อนไข (<code>and</code>, <code>or</code>, <code>not</code>)</h2><p>ใช้เมื่อต้องการตรวจสอบหลายเงื่อนไขพร้อมกัน</p>[LOGICAL_OPS_COMPONENT]<div class="note">💡 <code>and</code> ต้องจริงทั้งคู่ / <code>or</code> จริงแค่ตัวเดียวก็พอ</div>` },
                    { id: "4.8", title: "ตัวดำเนินการระบุเอกลักษณ์ (Identity Operators)", content: `<h2>ตรวจสอบตัวตน (<code>is</code>, <code>is not</code>)</h2><p>ใช้ตรวจว่าตัวแปรชี้ไปที่วัตถุ (Object) เดียวกันในหน่วยความจำหรือไม่</p>[IDENTITY_OPS_COMPONENT]<div class="note">💡 <code>==</code> ตรวจสอบ "ค่า", <code>is</code> ตรวจสอบ "ที่อยู่หน่วยความจำ"</div>` },
                    { id: "4.9", title: "ตัวดำเนินการความเป็นสมาชิก (Membership Operators)", content: `<h2>ตรวจสอบการเป็นสมาชิก (<code>in</code>, <code>not in</code>)</h2><p>ค้นหาว่ามีค่านั้นอยู่ใน List หรือ String หรือไม่</p>[MEMBERSHIP_OPS_COMPONENT]<div class="note">💡 ใช้ <code>in</code> เพื่อหาข้อความย่อย (Substring) ได้อย่างรวดเร็ว</div>` },
                    { id: "4.10", title: "ตัวดำเนินการระดับบิต (Bitwise Operators)", content: `<h2>จัดการข้อมูลระดับบิต</h2><p>ทำงานกับเลขฐาน 2 โดยตรง (มักใช้ในระบบเครือข่ายหรือ IoT)</p>[BITWISE_OPS_COMPONENT]<div class="note">💡 การเลื่อนบิตไปทางซ้าย (<code>&lt;&lt;</code>) เท่ากับการคูณด้วย 2</div>` },
                    { id: "4.11", title: "การใช้งานเงื่อนไข <code>if</code>", content: `<h2>เงื่อนไข <code>if</code></h2><p>ถ้าเงื่อนไขเป็นจริง ให้ทำงานตามคำสั่งที่ระบุ ลองปรับอุณหภูมิเพื่อดูผล</p>[IF_STATEMENT_COMPONENT]<div class="note">💡 บรรทัดใต้ if ต้องเว้นวรรค (Indentation) เสมอ</div>` },
                    { id: "4.12", title: "การใช้งานเงื่อนไข <code>elif</code>", content: `<h2>ทางเลือกหลายทาง (elif)</h2><p>ใช้เมื่อมีหลายเงื่อนไขที่ต้องตรวจสอบตามลำดับ เช่น การตัดเกรด</p>[ELIF_STATEMENT_COMPONENT]<div class="note">💡 Python จะทำคำสั่งใน elif บล็อกแรกที่เป็นจริงเท่านั้น</div>` },
                    { id: "4.13", title: "การใช้งานเงื่อนไข else", content: `<h2>ทางเลือกสุดท้าย (else)</h2><p>ถ้าไม่มีเงื่อนไขใดเป็นจริงเลย โปรแกรมจะเข้าสู่บล็อก <code>else</code></p>[ELSE_STATEMENT_COMPONENT]<div class="note">💡 บล็อก <code>else</code> ไม่ต้องใส่เงื่อนไขต่อท้าย</div>` },
                    { id: "4.14", title: "การทำงานซ้ำด้วย while loop", content: `<h2>วนซ้ำแบบมีเงื่อนไข (while)</h2><p>ทำงานไปเรื่อยๆ จนกว่าเงื่อนไขจะกลายเป็นเท็จ</p>[WHILE_LOOP_COMPONENT]<div class="note">💡 อย่าลืมอัปเดตเงื่อนไข (เช่น <code>count += 1</code>) ไม่งั้นโปรแกรมจะวนลูปไม่รู้จบ (Infinite Loop)!</div>` },
                    { id: "4.15", title: "การทำงานซ้ำด้วย for loop", content: `<h2>วนซ้ำตามจำนวนข้อมูล (for)</h2><p>ใช้เพื่อดึงข้อมูลทีละตัวออกจากโครงสร้างข้อมูล เช่น <code>List</code></p>[FOR_LOOP_COMPONENT]<div class="note">💡 <code>for item in list:</code> เป็นวิธีอ่านข้อมูลที่สะอาดและอ่านง่ายที่สุดใน Python</div>` },
                    { id: "4.16", title: "การใช้งานฟังก์ชัน <code>range()</code> ร่วมกับลูป", content: `<h2>สร้างช่วงตัวเลขด้วย range()</h2><p>ฟังก์ชันคู่บุญของ for loop สำหรับจัดการตัวเลข</p>[RANGE_FUNCTION_COMPONENT]<div class="note">💡 <code>range(start, stop, step)</code> ไม่รวมค่า stop เสมอ!</div>` },
                ],
                practical: [

...
export default function SQL21901_U1_L3_SQLDBMSSelector() {
  const initialTable = {
  "columns": [
    "id",
    "name",
  ...
  const queries = [
  {
    "id": "mysql",
    "sql": "MySQL",
    "desc": "ฟรี, เร็ว, นิยมใช้กับเว็บ เช่น WordPress, Facebook",
  ...
  },
  {
    "id": "pg",
    "sql": "PostgreSQL",
    "desc": "ฟรี, รองรับข้อมูลซับซ้อน, มาตรฐาน SQL สูง",
    "resultMsg": "Query executed successfully",
    "resultTable": {
      "columns": [
        "id",
  ...
  },
  {
    "id": "mssql",
    "sql": "SQL Server",
    "desc": "ของ Microsoft, เหมาะกับองค์กรขนาดใหญ่",
    "resultMsg": "Query executed successfully",
    "resultTable": {
      "columns": [
        "id",
  ...
  },
  {
    "id": "sqlite",
    "sql": "SQLite",
    "desc": "ฐานข้อมูลแบบไฟล์เดียว เหมาะกับแอปมือถือ",
    "resultMsg": "Query executed successfully",
    "resultTable": {
      "columns": [
        "id",
